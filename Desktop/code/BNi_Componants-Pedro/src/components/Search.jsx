...
{/* filter search bar ends */}
      <input
        className="flex-1 h-12 p-6 z-1 relative bg-white border-2 rounded-full shadow-md border-gray md:w-full text-md focus:border-gray focus:ring-gray focus:outline-gray focus:ring-opacity-40"
        type="search"
        name="search"
        placeholder="Search"
      ...
      <div className="absolute right-2 top-3">
        <button type="submit" className="p-2 rounded-full bg-neutral-200">
          <svg
            className="w-4 h-5 text-gray-600 fill-current"
